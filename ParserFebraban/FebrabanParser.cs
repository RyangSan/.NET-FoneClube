...
namespace Febraban
{
    public class FebrabanParser
    {
        public Conta Parse(string pathFile)
        {
            try
            {
                using (StreamReader file = new StreamReader(pathFile))
                {
                    ...
                    if (lineList[0].ToUpper().Contains("VIVO"))
                        tipoOperadora = OperatorType.Vivo;
                    else if (lineList[0].ToUpper().Contains("CLARO"))
                        tipoOperadora = OperatorType.Claro;
        ...
        public Conta ParserStreamReader(StreamReader file)
        {
            try
            {
        ...
        private Totalizador BuildTotalizador(List<string> totalizadorFinalList)
        {
        ...
        private List<Desconto> BuildDescontos(List<string> descontosList)
        {
        ...
        private List<Servico> BuildServicos(List<string> servicosList)
        {
            ...
            foreach (var servico in servicosList)
            {
                try
                {
                    servicos.Add(new Servico
                    {
                        ...
                        Filler = ""//servico.Substring(276, 74).Trim() // nã serve para nada e oferece risco em linhas menores
                    });
                }
                catch(Exception e) {
                    servicos.Add(new Servico());
        ...
        private List<Bilhetacao> BuildBilhetacoes(List<string> bilhetacaoList)
        {
        ...
        private Head BuildHead(List<string> headList)
        {
        ...
        private ListasRegistros BuildRegisterList(List<string> lineList)
        {
