...
(function () {
  ...
  function MainUtils($q, $cordovaFile, $ionicLoading, $ionicPopup) {
    ...
    this.toDisplayPhoneNumber = toDisplayPhoneNumber;
    ...
    function checkContains(strOrigin, strSearch) {
      try {
        const origin = removeAccents(strOrigin).toLowerCase();
        const search = removeAccents(strSearch).toLowerCase();
        if (search.indexOf(" ") > -1) {
          var val = search.split(" ");
          const res = true;
          for (var i in val) {
            if (origin.indexOf(val[i]) == -1) {
              return false;
            }
          }
          return res;
        } else {
          return origin.indexOf(search) > -1;
        }
      } catch {
        return false;
      }
    ...
    function toDisplayPhoneNumber(phone) {
      if (phone.length != 11) {
        return phone;
      } else {
